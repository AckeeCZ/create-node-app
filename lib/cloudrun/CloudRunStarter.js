...
class CloudRunStarter {
    ...
    install() {
        ...
        tb.copyAsset('ci-branch-config/common.env', tb.stringToPath(`${tb.destination}/ci-branch-config`));
        tb.copyAsset('ci-branch-config/development.env', tb.stringToPath(`${tb.destination}/ci-branch-config`));
        tb.copyAsset('ci-branch-config/stage.env', tb.stringToPath(`${tb.destination}/ci-branch-config`));
        tb.copyAsset('ci-branch-config/master.env', tb.stringToPath(`${tb.destination}/ci-branch-config`));
        tb.mkdir(tb.stringToPath(`${tb.destination}/docker-compose`));
        tb.copyAsset('docker-compose/docker-compose-entrypoint.sh', tb.stringToPath(`${tb.destination}/docker-compose`));
        tb.copyAsset('docker-compose/docker-compose.ci.yml', tb.stringToPath(`${tb.destination}/docker-compose`));
        tb.copyAsset('docker-compose/docker-compose.local.yml', tb.stringToPath(`${tb.destination}/docker-compose`));
        tb.copyAsset('docker-compose/docker-compose.override.yml', tb.stringToPath(`${tb.destination}/docker-compose`));
        tb.copyAsset('docker-compose/docker-compose.yml', tb.stringToPath(`${tb.destination}/docker-compose`));
        ...
        tb.copyAsset('src/test/helloWorld.test.ts', tb.stringToPath(`${tb.destination}/src/test`));
