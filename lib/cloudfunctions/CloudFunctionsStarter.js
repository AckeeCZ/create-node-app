...
exports.CloudFunctionsStarter = void 0;
class CloudFunctionsStarter {
    ...
    install() {
        ...
        tb.packageJson.addNpmScript('ci-lint', "eslint '**/*.ts' -f gitlab -o output/checkstyle-result.json");
...
exports.CloudFunctionsStarter = CloudFunctionsStarter;
